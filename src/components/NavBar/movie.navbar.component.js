...
return (
<>
<div className="container mx-auto px-4 flex items-center justify-between bg-darkCarousal-800">
...
return (
<>
<nav className="absolute inset-x-0 z-30 bg-opacity-10 backdrop-filter backdrop-blur-lg lg:relative  bg-darkCarousal-800 px-4 py-2">
